...
const Gallery = () => {
  const images = [
    { src: '/img/gallery/editar.jpg', alt: 'Imagen 1' },
    { src: '/img/gallery/inteligencia.jpg', alt: 'Imagen 2' },
    { src: '/img/gallery/PHP.jpg', alt: 'Imagen 3' },
    { src: '/img/gallery/programacion.jpg', alt: 'Imagen 4' },
  ];
