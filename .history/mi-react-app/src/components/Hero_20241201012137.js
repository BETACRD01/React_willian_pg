...
const Hero = () => {
  const [textColor, setTextColor] = useState('#fff'); // Color de texto predeterminado
  ...
  useEffect(() => {
    const calculateTextColor = (imageSrc) => {
      ...
      img.onload = () => {
        ...
        setTextColor(luminance > 127 ? '#000' : '#fff');
      };
    };
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        right: 0,
        bottom: 0,
        backgroundColor: 'rgba(0, 0, 0, 0.6)', // Más oscuro para resaltar texto
        zIndex: 0,
      }} />
      ...
      <div style={{
        position: 'relative',
        zIndex: 1,
        backgroundColor: 'rgba(0, 0, 0, 0.5)', // Fondo semitransparente para texto
        padding: '20px',
        ...
        <h2 style={{
          fontSize: '3em',
          textShadow: '2px 2px 4px rgba(0, 0, 0, 0.7)', // Sombra para mayor legibilidad
          margin: '0',
        }}>
